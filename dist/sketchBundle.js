...
var ComponentLibThemeProvider = function ComponentLibThemeProvider(_ref) {
  var _ref$theme = _ref.theme,
      theme = _ref$theme === void 0 ? baseTheme : _ref$theme,
      props = _objectWithoutProperties(_ref, ["theme"]);

  return React.createElement(ThemeProvider, _extends({
    theme: theme
  }, props));
};
...
var HeadlineContainer = function HeadlineContainer(_ref) {
  ...
  return React.createElement(TextContainer, _extends({
    fontSize: "h".concat(level),
    textStyle: "h".concat(level)
  }, props));
};
