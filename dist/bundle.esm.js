...
import os from 'os';
import { display, color, borderRadius, borderColor, borderWidth, space, height, width, border } from 'styled-system';
...
var Box = styled.View(_templateObject(), display, color, borderRadius, borderColor, borderWidth, space, height, width);
Box.defaultProps = {
  display: 'flex'
};
...
var StyledCircle = styled(Circle)(_templateObject$1(), border);
StyledCircle.defaultProps = {
  border: '5px solid green'
};

export { BoxContainer as Box, StyledCircle as Circle };
