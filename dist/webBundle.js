...
import os from 'os';
import { style, display, color, border, borderTop, borderBottom, borderLeft, borderRight, borderRadius, borderColor, borderWidth, space, height, width, opacity, flex, justifyContent, alignItems, flexDirection, justifySelf, alignSelf, fontSize, fontFamily, textColor, textAlign, textStyle, fontWeight, fontStyle, letterSpacing, lineHeight, maxHeight, maxWidth } from 'styled-system';
...
var isPlainObject = (function (x) {
  return (typeof x === 'undefined' ? 'undefined' : _typeof$1(x)) === 'object' && x.constructor === Object;
});
    ...
    for (var name in this) {
      ...
      if (value instanceof Array) {
        fixed[name] = value.map(function (i) {
          if ((typeof i === 'undefined' ? 'undefined' : _typeof$1(i)) === 'object' && i.toJSON) {
            return i.toJSON();
          } else {
            return i;
          }
        });
      } else if ((typeof value === 'undefined' ? 'undefined' : _typeof$1(value)) === 'object' && value.toJSON) {
...
function isPromise(obj) {
  return (typeof obj === 'undefined' ? 'undefined' : _typeof$1(obj)) === 'object' && typeof obj.then === 'function';
}
...
var LazyResult = function () {
  function LazyResult(processor, css, opts) {
    ...
    var root = void 0;
    if ((typeof css === 'undefined' ? 'undefined' : _typeof$1(css)) === 'object' && css.type === 'root') {
      root = css;
...
var Processor = function () {
  ...
  Processor.prototype.normalize = function normalize(plugins) {
    ...
    plugins.forEach(function (i) {
      ...
      if ((typeof i === 'undefined' ? 'undefined' : _typeof$1(i)) === 'object' && Array.isArray(i.plugins)) {
  ...
  StyledNativeComponent.prototype.render = function render() {
    ...
    return React.createElement(
      ...
      function (theme) {
        ...
        var propsForElement = _extends$1({}, _this2.attrs, props, {
...
var _StyledNativeComponent = (function (InlineStyle) {
  var createStyledNativeComponent = function createStyledNativeComponent(target, options, rules) {
    ...
    var WrappedStyledNativeComponent = React.forwardRef(function (props, ref) {
      return React.createElement(ParentComponent, _extends$1({}, props, {
...
var Rectangle = styled.View(_templateObject(), display, color, border, borderTop, borderBottom, borderLeft, borderRight, borderRadius, borderColor, borderWidth, borderBottomWidth, borderBottomColor, borderTopWidth, borderTopColor, borderLeftWidth, borderLeftColor, borderRightWidth, borderRightColor, space, height, width, opacity, flex); // $FlowFixMe
...
var Box = styled(Rectangle)(_templateObject$1(), justifyContent, alignItems, flexDirection, justifySelf, alignSelf); // $FlowFixMe
...
var BoxContainer = function BoxContainer(_ref) {
  var onClick = _ref.onClick,
      size = _ref.size,
      props = _objectWithoutProperties(_ref, ["onClick", "size"]);

  var box = React.createElement(Box, _extends({}, getSize(size), props));
...
var mixin = css(_templateObject$3(), fontSize, fontFamily, textColor, textAlign, textStyle, fontWeight, fontSize, fontStyle, space, letterSpacing, lineHeight, alignSelf, justifySelf, flex);
...
var Image = styled.Image(_templateObject$4(), color, border, borderRadius, borderColor, borderWidth, space, height, maxHeight, width, maxWidth, opacity); // $FlowFixMe
...
var HeadlineContainer = function HeadlineContainer(_ref) {
  var level = _ref.level,
      props = _objectWithoutProperties(_ref, ["level"]);

  var att = parseAttributes(level && {
    fontSize: getSize$1[level]
  });
  return React.createElement(TextContainer, _extends({}, att, props));
};
...
var Input$1 = styled(PrimitiveInput)(_templateObject$5(), mixin); // import { parseAttributes } from '../../../utils';
...
var TextInput = function TextInput(_ref) {
  ...
  // );
  return React.createElement(Input$1 // {...att}
  , props);
};
...
export { Circle, Rectangle, Line, BoxContainer as Box, TextContainer as Text, ImageContainer as Image, Button, HeadlineContainer as Headline, TextInput };
